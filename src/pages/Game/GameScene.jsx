    ...
    <div>

      {
        start ? (
          ...
          <button onClick={startGame} className="relative inline-block text-lg group">
...
<span className="relative">Offline Multiplayer</span>
</span>
<span className="absolute bottom-0 right-0 w-full h-16 -mb-3 -mr-1 transition-all duration-200 ease-linear bg-gray-900 rounded-lg group-hover:mb-0 group-hover:mr-0" data-rounded="rounded-lg"></span>
</button>
</div>
      }
